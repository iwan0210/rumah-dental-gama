...
router.get('/patient/monthly', verifyToken, registerHandler.getAllRegisterByYearMonthHandler)
router.get('/patient/daily', verifyToken, registerHandler.getAllRegisterByRangeDateHandler)
...
router.get('/export/monthly', verifyToken, registerHandler.getExportExcelMonthly)
router.get('/export/daily', verifyToken, registerHandler.getExportExcelDaily)
